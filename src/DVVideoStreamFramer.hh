...
class DVVideoStreamFramer2: public FramedFilter {
public:
  static DVVideoStreamFramer2*
...
protected:
  DVVideoStreamFramer2(UsageEnvironment& env, FramedSource* inputSource, Boolean sourceIsSeekable);
      // called only by createNew(), or by subclass constructors
  virtual ~DVVideoStreamFramer2();
