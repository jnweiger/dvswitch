...
// gcc -o dvsource-proxy dvsource-proxy.c -lavformat -lavcodec -lz

#endif

#include "avcodec_wrap.h"
#include <libavformat/avformat.h>	// from libffmpeg-devel-1.0.6-1.1.x86_64.rpm
...
\
The default PROXY_PORT is %s, use netcat to push data into the port.\
...
int main(int ac, char **av)
{
  ...
  //                      ctx,     name,  iformat, 
  if (avformat_open_input(&fctx, av[1], NULL, NULL) < 0)
    {
